			...
			Data: []ProviderInfo{
				{
					Name:              "OpenAI",
					Slug:              "openai",
					PrivacyPolicyURL:  new("https://openai.com/privacy"),
					TermsOfServiceURL: new("https://openai.com/terms"),
					StatusPageURL:     new("https://status.openai.com"),
				},
				{
					Name:              "Anthropic",
					Slug:              "anthropic",
					PrivacyPolicyURL:  new("https://anthropic.com/privacy"),
					TermsOfServiceURL: new("https://anthropic.com/terms"),
					StatusPageURL:     nil,
				},
			},
		}
